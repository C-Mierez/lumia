...
export default function HomeSection({ searchCategoryId }: HomeSectionProps) {
    return (
        ...
        <Suspense key={searchCategoryId} fallback={<HomeFallback />}>
            <ErrorBoundary fallback={<p>Something went wrong</p>}>
                <HomeSectionSuspense searchCategoryId={searchCategoryId} />
            </ErrorBoundary>
        </Suspense>
    );
}

function HomeSectionSuspense({ searchCategoryId }: HomeSectionProps) {
    const trpc = useTRPC();
