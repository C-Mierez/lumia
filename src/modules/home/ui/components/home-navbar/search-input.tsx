        ...
        <form className="group flex h-full w-full transition-colors" onSubmit={handleSearch}>
            <div className="relative w-full">
                <Input
                    ...
                    className="focus:bg-accent-600/20 focus:border-muted-foreground h-9 rounded-l-md rounded-r-none border-r-0 bg-transparent text-sm transition-colors focus:outline-none focus-visible:ring-0 md:text-sm"
                />
